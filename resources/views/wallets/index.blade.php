                    ...
                    <div class="card mb-4">
                        <div class="card-body bg-gray-100">
                            <div class="row mb-2">
                                <div class="col-md-9">
                                    <form action="{{ route('wallet.create') }}" method="POST">
                                        @csrf
                                        <button type="submit" class="btn btn-dark">Create Wallet</button>
                                    </form>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                {{-- <div class="d-flex justify-content-center">
                                    <div class="text-center"> <!-- Added text-center class -->
                                        <h6>Current Balance: $50,000</h6>
                                    </div>
                                </div> --}}
                                <div class="d-flex justify-content-center">
                                    <div class="text-center"> <!-- Added text-center class -->
                                        <h6>My Wallet Address:
                                            df952bd220cecb037be12d59e7d86532b8b0b9166e1cb69bd4cb094dee2bb2c9</h6>
                                    </div>
                                </div>
                            </div>
                            <hr>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                {{-- <td id="walletBalance">$200</td> --}}
                                                <td>
                                                    <form action="{{ route('pending.create') }}" method="POST"
